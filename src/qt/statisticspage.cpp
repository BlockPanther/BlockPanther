...
void StatisticsPage::updateStatistics()
{
    ...
    {
        subsidy = "20% Interest Per Annual Year";
    }
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " BPN" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " BPN" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " BPN");
    }
