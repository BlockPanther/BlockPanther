...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("BlockPanther-ext-ip");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("BlockPanther-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "BlockPanther " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("BlockPanther-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("BlockPanther-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("BlockPanther-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("BlockPanther-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BlockPanther is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("BlockPanther-start");
